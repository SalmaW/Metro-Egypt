...
public class StationLatLog {
    private double latitude;
    private double longitude;
    private String name;

    // Constructor
    public StationLatLog(String name, double latitude, double longitude) {
        this.name = name;
    ...
    public static void main(String[] args) {
        ...
        // Print stations for each line
        System.out.println("Line 1 Stations:");
        for (StationLatLog station : line1Stations) {
            System.out.println(station);
        }

        System.out.println("\nLine 2 Stations:");
        for (StationLatLog station : line2Stations) {
            System.out.println(station);
        }

        System.out.println("\nLine 3 Stations:");
        for (StationLatLog station : line3Stations) {
            System.out.println(station);
        }
    }
