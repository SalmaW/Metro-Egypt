...
public class MainCode {
    ...
    static boolean kitkatFlage = false;
    ...
    public static void main(String[] args) {
        ...
        if (!commonLines.isEmpty()) {
            ...
            getDirection();
            System.out.println("<<<<<<<<<<<<");
            getNewDirection(startStation, interchangeStation);
            ...
            System.out.println(" ");
            System.out.println("<<<<<<<<<<<<");
            getNewDirection(interchangeStation, endStation);
            System.out.println("kit kat flage is: " + kitkatFlage);
    ...
    public static String interchangeOfLine3(int startLine, int endLine, String startStation, ArrayList<String> startLineName) {
        String interchangeStation = "attaba";
    ...
    public static String getInterchangeStation(int startLine, int endLine, String startStation, ArrayList<String> startLineName) {
        ...
        } else if ((startLine == 2 && (endLine == 3 || endLine == 4)) || ((startLine == 3 || startLine == 4) && endLine == 2)) {
            interchangeStations = interchangeOfLine3(startLine, endLine, startStation, startLineName);//2&3
        } else if ((startLine == 1 && (endLine == 4 || endLine == 3)) || (endLine == 1 && (startLine == 4 || startLine == 3))) {
            interchangeStations = "nasser";// 1&3 + 1&4
